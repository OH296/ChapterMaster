...
advantage[i]="Devastator Doctrine";
advantage_tooltip[i]="The steady advance of overwhelming firepower is your chapters combat doctrine each company has an additional Devastator squad, all infantry have boosted defence, and heavy weapons have increased attack.";i+=1;
advantage[i]="Assault Doctrine";
advantage_tooltip[i]="Your chapter's prefers quick close quaters assault with the enemy each Company has an additional Assault Squad and your marines are more skilled in melee.";i+=1;
...
advantage[i]="Ryzan Patronage";
advantage_tooltip[i]="Your chapter has strong ties to the Forgeworld of Ryza as a result your Techmarines are privy to the secrets of their Techpriests enhancing your Plasma and Las weaponry.";i+=1;
