...
if (total_role_number > 0) {
    ...
    draw_set_color(0);
    draw_text(xx + 333, yy + 636, string_hash_to_newline("Requip All " + string(obj_ini.role[100][role]) + " With Default Items"));
    ...
    if (req_wep1 != "") {
        ...
        if (req_wep1_num > have_wep1_num) {
            draw_text_transformed(xx + 154, yy + 670, string_hash_to_newline("-Not enough " + string(req_wep1) + " (Have " + string(have_wep1_num) + ", Need " + string(req_wep1_num) + ")"), 0.6, 0.6, 0);
        }
        if (req_wep1_num <= have_wep1_num) {
            draw_text_transformed(xx + 154, yy + 670, string_hash_to_newline("-" + string(req_wep1) + " (Have " + string(have_wep1_num) + ", Need " + string(req_wep1_num) + ")"), 0.6, 0.6, 0);
        }
    }
    if (req_wep2 != "") {
        draw_set_color(c_gray);
        ...
        if (req_wep2_num > have_wep2_num) {
            draw_text_transformed(xx + 154, yy + 698, string_hash_to_newline("-Not enough " + string(req_wep2) + " (Have " + string(have_wep2_num) + ", Need " + string(req_wep2_num) + ")"), 0.6, 0.6, 0);
        }
        if (req_wep2_num <= have_wep2_num) {
            draw_text_transformed(xx + 154, yy + 698, string_hash_to_newline("-" + string(req_wep2) + " (Have " + string(have_wep2_num) + ", Need " + string(req_wep2_num) + ")"), 0.6, 0.6, 0);
        }
    }
    if (req_armour != "") {
        draw_set_color(c_gray);
        ...
        if (req_armour_num > have_armour_num) {
            draw_text_transformed(xx + 154, yy + 726, string_hash_to_newline("-Not enough " + string(req_armour) + " (Have " + string(have_armour_num) + ", Need " + string(req_armour_num) + ")"), 0.6, 0.6, 0);
        }
        if (req_armour_num <= have_armour_num) {
            draw_text_transformed(xx + 154, yy + 726, string_hash_to_newline("-" + string(req_armour) + " (Have " + string(have_armour_num) + ", Need " + string(req_armour_num) + ")"), 0.6, 0.6, 0);
        }
    }
    if (req_gear != "") {
        draw_set_color(c_gray);
        ...
        if (req_gear_num > have_gear_num) {
            draw_text_transformed(xx + 154, yy + 754, string_hash_to_newline("-Not enough " + string(req_gear) + " (Have " + string(have_gear_num) + ", Need " + string(req_gear_num) + ")"), 0.6, 0.6, 0);
        }
        if (req_gear_num <= have_gear_num) {
            draw_text_transformed(xx + 154, yy + 754, string_hash_to_newline("-" + string(req_gear) + " (Have " + string(have_gear_num) + ", Need " + string(req_gear_num) + ")"), 0.6, 0.6, 0);
        }
    }
    if (req_mobi != "") {
        draw_set_color(c_gray);
        ...
        if (req_mobi_num > have_mobi_num) {
            draw_text_transformed(xx + 154, yy + 782, string_hash_to_newline("-Not enough " + string(req_mobi) + " (Have " + string(have_mobi_num) + ", Need " + string(req_mobi_num) + ")"), 0.6, 0.6, 0);
        }
        if (req_mobi_num <= have_mobi_num) {
            draw_text_transformed(xx + 154, yy + 782, string_hash_to_newline("-" + string(req_mobi) + " (Have " + string(have_mobi_num) + ", Need " + string(req_mobi_num) + ")"), 0.6, 0.6, 0);
        }
    }
}
