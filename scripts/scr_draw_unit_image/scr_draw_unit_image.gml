            ...
            if (armour_type==ArmourType.None){            
                ...
                if (specific_helm!=false){
                    ...
                    if (role()==obj_ini.role[100][18]){
                        draw_sprite(specific_helm,0,x_surface_offset+helm_draw[0],y_surface_offset+0);
                    }else if(role()==obj_ini.role[100][19]){
                        draw_sprite(specific_helm,1,x_surface_offset+helm_draw[0],y_surface_offset+0);
                    } 
                    shader_set(sReplaceColor);
                }            
                // Apothecary Lens
